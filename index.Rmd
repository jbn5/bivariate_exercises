...
Exercise 1:<br> Turn the bars into lollipop with the right components.
</span>
...
Exercise 2:<br> Change the heatplot to ascending order, where intensity goes from yellow to purple.
</span>
_____
...
<a id='ex3'></a>
<span style="color:red"> 
Exercise 3:<br> Complete the information needed in the previous plots.
